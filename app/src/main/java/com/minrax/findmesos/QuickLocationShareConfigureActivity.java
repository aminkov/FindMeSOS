 ...
 */
public class QuickLocationShareConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            QuickLocationShare.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public QuickLocationShareConfigureActivity() {
        super();
    }
